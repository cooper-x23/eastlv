...
function enableContrast()
	--if a == true then
		...
		blurHShader,tecName = dxCreateShader( "shaders/contrast/blurH.fx" )
	--	outputDebugString( "blurHShader is using technique " .. tostring(tecName) )

		blurVShader,tecName = dxCreateShader( "shaders/contrast/blurV.fx" )
	--	outputDebugString( "blurVShader is using technique " .. tostring(tecName) )

		brightPassShader,tecName = dxCreateShader( "shaders/contrast/brightPass.fx" )
	--	outputDebugString( "brightPassShader is using technique " .. tostring(tecName) )

		addBlendShader,tecName = dxCreateShader( "shaders/contrast/addBlend.fx" )
...
addEventHandler( "onClientHUDRender", root,
    function()
		if not showContrast then return end
